            ...
            <form action="" wire:submit.prevent='store()'>
                    ...
                    <div>
                        ...
                        <input class="form-input" id="name"
                            wire:model.lazy='name' type="text" required>
                    ...
                    <div class="mt-4">
                        <label class="block text-sm font-medium text-gray-700 leading-5" for="password_confirmation">Confirmar Senha</label>
                        <input class="form-input" id="password_confirmation"
                            wire:model.lazy='password_confirmation' type="password">
                    </div>

                    <button class=" bg-blue-800 hover:opacity-80 text-white font-bold py-2 w-full rounded-md shadow-sm mt-5" type="submit">Salvar</button>
